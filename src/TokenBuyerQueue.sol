 ...
 */
contract TokenBuyerQueue is Ownable, Pausable, ReentrancyGuard {
    ...
    function buyETH(uint256 tokenAmount) external nonReentrant whenNotPaused {
        ...
        IPayerQueue(payer).payBackDebt(amount);
    ...
    function tokenAmountNeeded() public view returns (uint256) {
        ...
        uint256 iouSupply = IPayerQueue(payer).totalDebt();
        unchecked {
